  ...
  return (
    <main className="home min-h-screen bg-slate-200 p-2">
      ...
      <section className="flex items-start justify-between bg-purple-600">
        ...
        <div className="card-container grid min-w-fit grid-cols-1 gap-3 bg-green-400 p-3 md:grid-cols-3">
          <div className="card h-36 w-36 bg-red-700 md:h-40 md:w-40 lg:h-44 lg:w-44"></div>
          <div className="card h-36 w-36 bg-red-700 md:h-40 md:w-40 lg:h-44 lg:w-44"></div>
          <div className="card h-36 w-36 bg-red-700 md:h-40 md:w-40 lg:h-44 lg:w-44"></div>
          <div className="card h-36 w-36 bg-red-700 md:h-40 md:w-40 lg:h-44 lg:w-44"></div>
          <div className="card h-36 w-36 bg-red-700 md:h-40 md:w-40 lg:h-44 lg:w-44"></div>
